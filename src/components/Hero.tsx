            ...
            <div className="relative">
              ...
              <div className="relative grid grid-cols-2 gap-4">
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all duration-300 h-40 flex flex-col justify-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2 text-center">환자 케어</h3>
                  <p className="text-sm text-gray-600 text-center">24/7 전문 의료진 상담</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all duration-300 h-40 flex flex-col justify-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2 text-center">안전보장</h3>
                  <p className="text-sm text-gray-600 text-center">JCI 인증 의료기관</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all duration-300 h-40 flex flex-col justify-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2 text-center">글로벌 연결</h3>
                  <p className="text-sm text-gray-600 text-center">15개국 파트너 네트워크</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 transform hover:scale-105 transition-all duration-300 h-40 flex flex-col justify-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2 text-center">합리적 비용</h3>
                  <p className="text-sm text-gray-600 text-center">투명한 가격 책정</p>
                </div>
              </div>
              ...
              <div className="mt-6 bg-gradient-to-r from-medical/5 to-blue-500/5 rounded-2xl p-6 border border-medical/10">
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <div className="text-center">
                    <div className="text-lg font-semibold text-gray-900">Korean Medical Excellence</div>
                    <div className="text-sm text-gray-600">세계가 인정하는 의료 기술력</div>
                  </div>
                </div>
              </div>
            </div>
